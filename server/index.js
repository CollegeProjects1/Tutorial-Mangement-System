...
app.post("/get_message",(req,res)=>{
    if(req){
        ...
        db.query("SELECT cdate,ctime,cdate,room_no,cEndTime,subject,description FROM tutorial_mng_sys.teachers as t , tutorial_mng_sys.class as c where c.tid=? and t.tid=? and t.password = ? order by cdate asc;",
